    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('inicio') }}">
        <div class="sidebar-brand-icon rotate-n-15">
          <i class="fas fa-box-open" style="color:lightgreen"></i>
        </div>
        <div class="sidebar-brand-text mx-3">AgroNorte</div>
      </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Agroexportadora del norte {{date("Y")}}</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
